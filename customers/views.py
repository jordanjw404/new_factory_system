...
from .forms import CustomerDocumentForm, CustomerForm, CustomerImportForm
...
def customer_detail_list(request):
    ...
    return render(
        request,
        "customers/customer_detail_list.html",
        {
            "customers": customers,
        },
    )
...
def customer_edit(request, pk):
    ...
    return render(
        request, "customers/customer_form.html", {"form": form, "edit_mode": True}
    )
