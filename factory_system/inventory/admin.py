...
from .models import Inventory, Supplier, Cabinet, Hardware, Board, EdgeBanding, Inventory
@admin.register(Inventory)
class InventoryAdmin(admin.ModelAdmin):
    list_display = ('barcode', 'item', 'quantity_on_hand', 'quantity_reserved', 'quantity_available', 'barcode_image_tag')
