...
class ProductionStageForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            "prep_status", "build_status", "fittings_status", "wrapping_status",
            "quality_status",
            "sales_target_date", "programming_target_date", "nest_target_date",
            "edge_target_date", "prep_target_date", "build_target_date",
            "fittings_target_date", "wrapping_target_date", "quality_target_date",
            "sales_completed_date", "programming_completed_date",
            "nest_completed_date", "edge_completed_date", "prep_completed_date",
            "build_completed_date", "fittings_completed_date",
            "wrapping_completed_date", "quality_completed_date"
        ]
